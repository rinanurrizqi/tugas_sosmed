...
<div class="form-container" style="max-width: 500px; margin: 20px auto; background: white; border-radius: 30px; padding: 35px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
    ...
    <form method="post" action="<?= isset($email) ? base_url('email/update/'.$email['id_email']) : base_url('email/store') ?>">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" 
                   ...
                   value="<?= old('id_email', $email['id_email'] ?? '') ?>"
        ...
        <div style="margin-bottom: 30px;">
            ...
            <div style="position: relative;">
                <i class="fas fa-envelope" style="position: absolute; left: 20px; top: 50%; transform: translateY(-50%); color: #ea4335; font-size: 18px; z-index: 1;"></i>
                <input type="email" 
                       name="alamat_email"
                       ...
                       value="<?= old('alamat_email', $email['alamat_email'] ?? '') ?>"
