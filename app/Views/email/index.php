            ...
            <tbody>
                <?php if (!empty($email) && is_array($email)): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $em['id_email'] ?></td>
                        <td>
                            <a href="mailto:<?= $em['alamat_email'] ?>" style="color: #3b82f6; text-decoration: none;">
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <!-- Tombol Hapus -->
                                <form action="<?= base_url('email/delete/'.$em['id_email']) ?>" method="post" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                    <?= csrf_field() ?>
