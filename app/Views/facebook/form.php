...
<!-- Topbar -->
<div class="topbar">
    <h2><?= isset($facebook) ? 'Edit Akun Facebook' : 'Tambah Akun Facebook' ?></h2>
</div>
...
<div class="form-container" style="max-width: 500px; margin: 20px auto; background: white; border-radius: 30px; padding: 35px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
    ...
    <form method="post" action="<?= isset($facebook) ? base_url('facebook/update/'.$facebook['id_facebook']) : base_url('facebook/store') ?>">
        ...
        <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 10px; font-weight: 600; color: #0f172a;">
                ID Facebook <span style="color: #ef4444;">*</span>
            </label>
            <input type="text" 
                   name="id_facebook"
                   ...
                   value="<?= old('id_facebook', $facebook['id_facebook'] ?? '') ?>"
                   placeholder="Contoh: FB001"
                   <?= isset($facebook) ? 'readonly' : '' ?>
        ...
        <div style="margin-bottom: 30px;">
            <label style="display: block; margin-bottom: 10px; font-weight: 600; color: #0f172a;">
                Link Facebook <span style="color: #ef4444;">*</span>
            </label>
            <div style="position: relative;">
                <i class="fab fa-facebook" style="position: absolute; left: 20px; top: 50%; transform: translateY(-50%); color: #1877f2; font-size: 18px; z-index: 1;"></i>
                <input type="url" 
                       name="link_facebook"
                       ...
                       value="<?= old('link_facebook', $facebook['link_facebook'] ?? '') ?>"
            ...
            <div style="font-size: 12px; color: #64748b; margin-top: 5px; margin-left: 5px;">
                <i class="fas fa-info-circle" style="color: #3b82f6;"></i>
                Masukkan URL lengkap akun Facebook
            </div>
        </div>
