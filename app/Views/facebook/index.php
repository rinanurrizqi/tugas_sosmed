...
<div class="data-akun-section">
    ...
    <div class="section-header">
        ...
        <!-- Tombol Tambah Akun -->
        <a href="<?= base_url('facebook/create') ?>" class="btn-tambah">
            ...
            <tbody>
                <?php if (!empty($facebook) && is_array($facebook)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= $fb['link_facebook'] ?>" target="_blank" style="color: #3b82f6; text-decoration: none;">
                        ...
                        <td>
                            <div class="action-buttons">
                                <!-- Tombol Edit -->
                                <a href="<?= base_url('facebook/edit/'.$fb['id_facebook']) ?>" class="btn-edit">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                </a>
                                
                                <!-- Tombol Hapus -->
                                <form action="<?= base_url('facebook/delete/'.$fb['id_facebook']) ?>" method="post" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                    <?= csrf_field() ?>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" style="text-align: center; padding: 40px; color: #64748b;">
                            <i class="fab fa-facebook" style="font-size: 32px; display: block; margin-bottom: 10px;"></i>
                            Belum ada data akun Facebook
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
