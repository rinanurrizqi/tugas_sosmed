...
<!-- Topbar -->
<div class="topbar">
    <h2><?= isset($whatsapp) ? 'Edit Akun WhatsApp' : 'Tambah Akun WhatsApp' ?></h2>
</div>
...
<div class="form-container" style="max-width: 500px; margin: 20px auto; background: white; border-radius: 30px; padding: 35px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
    ...
    <form method="post" action="<?= isset($whatsapp) ? base_url('whatsapp/update/'.$whatsapp['id_wa']) : base_url('whatsapp/store') ?>">
        ...
        <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 10px; font-weight: 600; color: #0f172a;">
                ID WhatsApp <span style="color: #ef4444;">*</span>
            </label>
            <input type="text" 
                   name="id_wa"
                   ...
                   value="<?= old('id_wa', $whatsapp['id_wa'] ?? '') ?>"
                   placeholder="Contoh: WA001"
                   <?= isset($whatsapp) ? 'readonly' : '' ?>
        ...
        <div style="margin-bottom: 30px;">
            ...
            <div style="position: relative;">
                <i class="fab fa-whatsapp" style="position: absolute; left: 20px; top: 50%; transform: translateY(-50%); color: #25D366; font-size: 18px; z-index: 1;"></i>
                <input type="text" 
                       name="no_wa"
                       ...
                       value="<?= old('no_wa', $whatsapp['no_wa'] ?? '') ?>"
            ...
            <div style="font-size: 12px; color: #64748b; margin-top: 5px; margin-left: 5px;">
                <i class="fas fa-info-circle" style="color: #3b82f6;"></i>
                Masukkan nomor WhatsApp dengan kode negara (contoh: 628123456789)
            </div>
        </div>
